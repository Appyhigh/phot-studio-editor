                ...
                <section className={classes.sectionToolsCon}>
                    ...
                    <Block className={classes.sectionCardWrap}>
                        {TEMPLETS_DATA.map((data, index) => {
                            return <div onClick={() => setModalOpen(true)} >
                                <TempletCard data={data} key={index} isModalOpen={isModalOpen} HandleClose={HandleClose} />
                            </div>
                        })}
                    </Block>
                </section>
            ))}
            {isModalOpen && <TempleteModal isModalOpen={isModalOpen} HandleClose={HandleClose} />}

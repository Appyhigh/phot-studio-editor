function Save({ size }: { size: number }) {
  return (
    <svg width="24" height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M23 4V10H17" stroke="#696974" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M1 20V14H7" stroke="#696974" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path

function UploadBaseIcon({ size }: { size: any }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_2270_67815)">
        <path d="M12 14.25V3.75" stroke="#6729F3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path

function BgRemover({ size,color }: { size: any, color:any}) {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M13.5 18.5L19 12.5L25 17.5" stroke={color} stroke-linecap="round" stroke-linejoin="round" />
      <path
        d="M25 19C25 20.1046 24.1046 21 23 21L14 21L14 7L23 7C24.1046 7 25 7.89543 25 9L25 19Z"
        stroke={color}
        stroke-width="2"
      />
      <path d="M14 3L14 25" stroke={color} stroke-width="2" stroke-linecap="round" />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"

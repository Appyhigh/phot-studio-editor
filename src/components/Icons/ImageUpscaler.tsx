function ImageUpscaler({ size,color }: { size: any,color:any }) {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M2 24H9V20H6V17.25H2V24Z" fill={color} />
      <path fill-rule="evenodd" clip-rule="evenodd" d="M2 2H9V6H6V8.75H2V2Z" fill={color} />
      <path d="M16 16L19 19L22 22" stroke={color} stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
      <path
        d="M15.002 15.002H20.148"
        stroke={color}
        stroke-width="3"

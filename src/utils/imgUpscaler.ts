...
export const img2Upscaler = async (sourceUrl: string, fileName?: string) => {
  try {
    const url = API_BASE_URL + "/app/api/v3/user_activity/create-enhancer-2k"
    const body = {
      sourceUrl: sourceUrl,
      fileName: fileName,
    }
...
export const imgBothUpscaler = async (sourceUrl: string, fileName?: string) => {
  try {
    const url = API_BASE_URL + "/app/api/v3/user_activity/create-enhancer-2k-4k"
    const body = {
      sourceUrl: sourceUrl,
      fileName: fileName,
    }
...
export const img4Upscaler = async (sourceUrl: string, fileName?: string) => {
  try {
    const url = API_BASE_URL + "/app/api/v3/user_activity/create-enhancer-4k"
    const body = {
      sourceUrl: sourceUrl,
      fileName: fileName,
    }
